      ...
      <div className="grid gap-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Yazınızın başlığını, içeriğini ve diğer detaylarını girin.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6">
              ...
              <div className="grid gap-3">
                ...
                <Textarea
                  id="content"
                  placeholder="Yazı içeriğini buraya yazın. Markdown desteklenmektedir."
                  className="min-h-96"
                />
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Kategori ve Görsel</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="grid gap-3">
                <Label htmlFor="cover-image">Başlık Resmi</Label>
